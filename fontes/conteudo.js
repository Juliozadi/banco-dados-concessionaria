...
module.exports = ({ resultados, trecho }) => {
  ...
  const blocos = [
    ...
    { t: 'codigo', id: 'cod_restricoes', titulo: 'Consulta às restrições criadas no banco', codigo: trecho('SELECT conrelid::regclass', 'ORDER BY conrelid::regclass::text, tipo, conname;') },
